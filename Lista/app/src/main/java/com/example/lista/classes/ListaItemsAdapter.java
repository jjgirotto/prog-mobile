package com.example.lista.classes;
...
public class ListaItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    class FlorViewHolder extends AnimalViewHolder {
        ...
        FlorViewHolder(View view) {
            super(view);
            mesCultivo = view.findViewById(R.id.textoMesCultivo);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2:
                itemView = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.list_flor, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case 2:
                ...
                florViewHolder.mesCultivo.setText(((Flower) items.get(position)).getSeedingMonth());
